...
################################################################
# Title:  search.py
# Info :  highlights search terms
#         adapted as indicated below
################################################################

# From djangosnippets.com
...
SETTINGS_DEFAULTS = {
    ...
    'IGNORE_CASE': True,
    'WORD_BOUNDARY': False,
    'HIGHLIGHT_CLASS': "font-weight: bold;" # "highlight"
}
...
def highlight(text, phrases, ignore_case=None, word_boundary=None, class_name=None):
    ...
    template = '<span%s style="font-weight: 900; font-size: 1.1em; color: orange;">%%s</span>' % ''
    matches = []

...
print '------------------------------'
print 'Running cronjob: renew.py'
print datetime.now()
print ''  

groups = Group.objects.filter(active_status='A')

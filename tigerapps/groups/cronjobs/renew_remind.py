...
print '------------------------------'
print 'Running cronjob: renew_remind.py'
print datetime.now()
print ''  
...
for group in groups:
    ...
    # send email
    send_mail(EMAIL_HEADER_PREFIX+'REMINDER: Renew %s Profile'%group.name, GROUP_RENEWAL_REMIND_EMAIL % (group.name,group.url), SITE_EMAIL, list, fail_silently=False)

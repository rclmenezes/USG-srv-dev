...
#Edited by Rodrigo Menezes
#   LDAP changes: pustatus is now either "graduate" or "undergraduate"
#   class year is now "puclassyear" academic level is now"puacademiclevel"
def gdi(netid):

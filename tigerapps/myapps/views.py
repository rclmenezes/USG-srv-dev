...
def ice_courses(request, settings):
    ...
    for timetable in timetables:
        ...
        for course in courses:
            ...
            return_val += "Title: " + title + "<br/>Description: " + description + "<br/>Lecture: " + lecture
    return HttpResponse(return_val)
        
def course_lookup(request, settings):
...
def anon_email(request, settings):
    if 'M' in request.GET and bool(request.GET['M']):
        return render_to_response('my/myapps/anon_email_m.html')
    else:
        return render_to_response('my/myapps/anon_email_s.html')
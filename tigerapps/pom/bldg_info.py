...
BLDG_INFO = {
    ...
    'MCCOH': ('McCosh Hall',('Department of English','Program in American Studies',),True),
    ...
    'MCCOS': ('McCosh Health Center',('University Health Services',),True),

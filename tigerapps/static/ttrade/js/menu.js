...
jQuery(function() {
    ...
    $('.menu>li', '#menu').hover(
        function(){
            ...
            else setTimeout(function(){ $('#menu').removeClass('js-active'); }, 500);
        },
        function(){
            var ul  = $('div:first', this);
            if (ul.length){
    ...
    // lava lamp
//     if (ie6){
//         $('#menu ul.menu>li').hover(function(){ $(this).addClass('hover'); }, function(){ $(this).removeClass('hover'); });
//         $('#menu ul.menu').lavaLamp({speed: 300});
//     }
//     else $('#menu ul.menu').lavaLamp({fx: 'backout', speed: 500});
    // animation
//     $('ul ul a', '#menu').hover(
